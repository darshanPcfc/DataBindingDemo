package com.example.databindingdemo.ui.widget;
...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private void drawButtons(Canvas c, View itemView, List<UnderlayButton> buffer, int pos, float dX) {
        ...
        tv2.setText(" Delete ");
        tv2.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary_second));
        tv2.setTextColor(context.getResources().getColor(R.color.colorWhite));
        tv2.setPadding(10, 10, 10, 10);
        layout.addView(tv1,params);
        layout.addView(tv2,params);
        card.addView(layout,params);*/
